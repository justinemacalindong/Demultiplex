...
def outputting(file1, file2, read1, read2, index1, reverse):
    '''This function writes a FASTQ file and modifies the header to add the barcodes from index files to them.'''
    file1.write(str(read1[0] + "_" + index1[1] + "_" + reverse + '\n' + read1[1] + '\n'+ read1[2] + '\n' + read1[3] + '\n'))
    file2.write(str(read2[0] + "_" + index1[1] + "_" + reverse + '\n' + read2[1] + '\n'+ read2[2] + '\n' + read2[3] + '\n'))
...
if __name__ == "__main__":
    ...
    assert reverse_complement("ACTGA") == TCAGT
    assert reverse_complement("GATTACA") == TGTAATC
    print("correctly reverse complemented a sequence")